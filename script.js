  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('input', function (e) {
      ...
      if (
        ...
        if (field.closest('.contact-form') === contactForm) {
          validateField(field);
        }
      }
    });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בית מדרש קהילתי לרבנים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '158ab9b1-1b1c-421d-83cf-bffc72065a06',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '158ab9b1-1b1c-421d-83cf-bffc72065a06';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '158ab9b1-1b1c-421d-83cf-bffc72065a06';
